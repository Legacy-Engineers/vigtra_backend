...
from modules.insuree.models.insuree_dependency import Gender, Profession, Education
...
class InsureeServiceTest(BaseServiceTestCase, TestDataMixin):
    ...
    def test_delete_insuree_service(self):
        ...
        self.assertTrue(
            insuree.status == InsureeStatus.INACTIVE or
            insuree.validity_to is not None
        )
