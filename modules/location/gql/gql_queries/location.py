...
def get_location_gql_types():
    ...
    class LocationGQLType(DjangoObjectType):
        ...
        full_path = graphene.String(
            description="Full hierarchical path of the location"
        )
    ...
    return LocationGQLType, LocationTypeGQLType


# Create the types when the module is imported
LocationGQLType, LocationTypeGQLType = get_location_gql_types()
