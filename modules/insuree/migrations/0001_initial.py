    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.AutoField(
                        db_column="EducationId", primary_key=True, serialize=False
                    ),
                ),
                (
                    "education",
                ...
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Whether education level is active"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text="Family type description",
                        max_length=50,
                    ),
                ),
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Whether this family type is active"
                    ),
                ),
                (
                    "sort_order",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "code",
                    models.CharField(
                        help_text="Identification type code",
                        max_length=10,
                        primary_key=True,
                        serialize=False,
                    ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Identification type name",
                        max_length=100,
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Prefix for the identification code",
                        max_length=10,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Suffix for the identification code",
                        max_length=10,
                        null=True,
                    ),
                ),
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Whether identification type is active"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "json_ext",
                    models.JSONField(blank=True, db_column="JsonExt", null=True),
                ),
                (
                    "validity_from",
                ...
                (
                    ...
                    models.UUIDField(
                        default=uuid.uuid4,
                        editable=False,
                        help_text="Unique identifier for the insuree",
                        unique=True,
                    ),
                ),
                (
                    "chf_id",
                    models.CharField(
                        help_text="CHF identification number",
                        max_length=50,
                        unique=True,
                    ),
                ),
                ...
                (
                    "other_names",
                    models.CharField(help_text="Other names", max_length=100),
                ),
                (
                    "dob",
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        db_column="Photo",
                        help_text="Photo of the insuree",
                        max_length=255,
                        null=True,
                        upload_to="insuree/photos/%Y/%m/",
                    ),
                ),
                (
                    "photo_date",
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        default=False,
                        help_text="Whether card has been issued",
                    ),
                ),
                (
                    "card_issued_date",
                    models.DateField(
                        blank=True, help_text="Date card was issued", null=True
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Identification number",
                        max_length=50,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        db_column="isOffline",
                        default=False,
                        help_text="Whether created offline",
                    ),
                ),
                (
                    "status",
                ...
                (
                    ...
                    models.DateField(
                        ...
                        help_text="Date status was changed",
                        null=True,
                    ),
                ),
                (
                    "created_date",
                    models.DateTimeField(
                        auto_now_add=True, help_text="Date insuree was created"
                    ),
                ),
                (
                    "last_modified",
                    models.DateTimeField(
                        auto_now=True, help_text="Date insuree was last modified"
                    ),
                ),
                (
                    "notes",
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        db_column="AuditUser",
                        help_text="User who last modified the insuree",
                        null=True,
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Associated health facility",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Identification type",
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        to="insuree.identificationtype",
                    ),
                ),
                (
                    "location",
                    models.ForeignKey(
                        help_text="Location of the insuree",
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="Other associated health facility",
                        related_name="insurees_other_health_facility",
                        to="location.healthfacility",
                    ),
                ),
                (
                    "secondary_health_facility",
                    models.ForeignKey(
                        blank=True,
                        help_text="Secondary associated health facility",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id",
                    models.AutoField(
                        db_column="FamilyID", primary_key=True, serialize=False
                    ),
                ),
                (
                    "uuid",
                    models.UUIDField(
                        ...
                        default=uuid.uuid4,
                        editable=False,
                        help_text="Unique identifier for the family",
                        unique=True,
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        db_column="Poverty",
                        default=False,
                        help_text="Whether family is in poverty",
                    ),
                ),
                (
                    "address",
                ...
                (
                    ...
                    models.BooleanField(
                        db_column="isOffline",
                        default=False,
                        help_text="Whether family was created offline",
                    ),
                ),
                (
                    "ethnicity",
                ...
                (
                    "created_date",
                    models.DateTimeField(
                        auto_now_add=True, help_text="Date family was created"
                    ),
                ),
                (
                    "last_modified",
                    models.DateTimeField(
                        auto_now=True, help_text="Date family was last modified"
                    ),
                ),
                (
                    "notes",
                    models.TextField(
                        blank=True,
                        help_text="Additional notes about the family",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        db_column="AuditUser",
                        help_text="User who last modified the family",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        to=settings.AUTH_USER_MODEL,
                    ),
                ...
                (
                    ...
                    models.ForeignKey(
                        db_column="InsureeID",
                        help_text="Head of the family (maintained for compatibility)",
                        on_delete=django.db.models.deletion.PROTECT,
            ...
            fields=[
                ...
                (
                    ...
                    models.UUIDField(
                        ...
                        default=uuid.uuid4,
                        editable=False,
                        help_text="Unique identifier for the insuree identification",
                        null=True,
                        unique=True,
                    ),
                ),
                (
                    "identification_number",
                    models.CharField(help_text="Identification number", max_length=50),
                ),
                (
                    "identification_type",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.AutoField(
                        db_column="ProfessionId", primary_key=True, serialize=False
                    ),
                ),
                (
                    "profession",
                ...
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Whether profession is active"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.AutoField(
                        db_column="RelationId", primary_key=True, serialize=False
                    ),
                ),
                (
                    "relation",
                ...
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Whether relationship is active"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_head",
                    models.BooleanField(
                        default=False, help_text="Whether this member is head of family"
                    ),
                ),
                (
                    "status",
                ...
                (
                    ...
                    models.DateField(
                        default=datetime.date.today, help_text="Date membership started"
                    ),
                ),
                (
                    "membership_end_date",
                    models.DateField(
                        blank=True, help_text="Date membership ended", null=True
                    ),
                ),
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="Notes about this membership", null=True
                    ),
                ),
                (
                    "created_date",
                    models.DateTimeField(
                        auto_now_add=True, help_text="Date membership was created"
                    ),
                ),
                (
                    "last_modified",
                    models.DateTimeField(
                        auto_now=True, help_text="Date membership was last modified"
                    ),
                ),
                (
                    "is_valid",
                    models.BooleanField(
                        default=True, help_text="Whether this membership is valid"
                    ),
                ),
                (
                    "has_claim_benefits",
                    models.BooleanField(
                        default=True,
                        help_text="Whether this membership has claim benefits",
                    ),
                ),
                (
                    "audit_user",
                    models.ForeignKey(
                        blank=True,
                        help_text="User who last modified the membership",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        to=settings.AUTH_USER_MODEL,
                    ),
                ...
                (
                    "family",
                    models.ForeignKey(
                        help_text="Family this membership belongs to",
                        on_delete=django.db.models.deletion.CASCADE,
                ...
                (
                    "insuree",
                    models.ForeignKey(
                        help_text="Insuree who is a member",
                        on_delete=django.db.models.deletion.CASCADE,
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Relationship to head of family",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        to="insuree.relation",
                    ),
        ...
        migrations.AddIndex(
            model_name="family",
            index=models.Index(
                fields=["confirmation_no"], name="idx_family_confirmation"
            ),
        ),
        migrations.AddIndex(
            model_name="family",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(("confirmation_no__isnull", True)),
        ...
        migrations.AddIndex(
            model_name="insuree",
            index=models.Index(
                fields=["last_name", "other_names"], name="idx_insuree_names"
            ),
        ),
        migrations.AddIndex(
            model_name="insuree",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                condition=models.Q(("chf_id__isnull", False)),
                fields=("chf_id",),
                name="unique_chf_id",
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="familymembership",
            index=models.Index(
                fields=["membership_start_date"], name="idx_membership_start"
            ),
        ),
        migrations.AddIndex(
            model_name="familymembership",
            index=models.Index(
                fields=["membership_end_date"], name="idx_membership_end"
            ),
        ),
        migrations.AddIndex(
            model_name="familymembership",
        ...
        migrations.AddConstraint(
            model_name="familymembership",
            constraint=models.UniqueConstraint(
                condition=models.Q(("is_head", True), ("status", "AC")),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("membership_end_date__isnull", True),
                    ("membership_end_date__gte", models.F("membership_start_date")),
                    _connector="OR",
                ),
