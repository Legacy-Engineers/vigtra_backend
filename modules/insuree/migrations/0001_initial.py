...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='family',
            constraint=models.CheckConstraint(condition=models.Q(('confirmation_no__isnull', True)), name='chk_family_confirmation_min_length'),
        ),
        migrations.AddIndex(
            model_name='insuree',
        ...
        migrations.AddConstraint(
            model_name='insuree',
            constraint=models.CheckConstraint(condition=models.Q(('dob__lte', datetime.date(2025, 7, 12))), name='chk_insuree_dob_not_future'),
        ),
        migrations.AddIndex(
